...
RED = "#f87171"
VIOLET = "#a78bfa"
SHELL_BG = "linear-gradient(145deg, rgba(30, 27, 75, 0.7) 0%, rgba(9, 9, 11, 0.9) 100%)"
SHELL_BORDER = "rgba(255, 255, 255, 0.1)"
SHELL_SHADOW = "rgba(0, 0, 0, 0.6)"
GLASS_BG = "rgba(255, 255, 255, 0.03)"
GLASS_SHADOW = "rgba(0, 0, 0, 0.4)"
FILE_DROP_BG = "rgba(255, 255, 255, 0.02)"
CHAT_INPUT_BG = "rgba(9, 9, 11, 0.8)"
TEXTAREA_BG = "rgba(24, 24, 27, 0.6)"
